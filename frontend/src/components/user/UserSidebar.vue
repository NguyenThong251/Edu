...
import { ArrowLeftStartOnRectangleIcon, ClipboardDocumentCheckIcon, FolderOpenIcon, HeartIcon, HomeIcon, LockClosedIcon, UserIcon } from '@heroicons/vue/24/outline';
