...
<template>
  <div
    class="col-span-12 border border-stroke bg-white px-5 pt-7.5 pb-5 shadow-default dark:border-strokedark dark:bg-dark-sidebar dark:text-white sm:px-7.5 xl:col-span-8 rounded-[10px] shadow-lg"
  >
    <div class="flex flex-wrap items-start justify-between gap-3 sm:flex-nowrap pt-4">
