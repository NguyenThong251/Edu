...
import { SidebarItem } from '@/interfaces/admin.interface';
...
<template>
    <li class="relative">
      <router-link 
      :to="props.item.route" 
      class="gap-2 flex  hover:bg-slate-500 p-3 rounded-[5px] items-center relative" 
      :class="{
      ...
      >
        <component :is="props.item.icon" class="w-6 h-6" 
        :class="{
        ...
        <ChevronRightIcon v-if="props.item.children" 
