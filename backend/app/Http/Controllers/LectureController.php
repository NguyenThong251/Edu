...
class LectureController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'content_link.required' => __('messages.content_required'),
            'content_link.file' => __('messages.content_file'),
            'content_link.mimes' => __('messages.content_mimes'),
            'content_link.max' => __('messages.content_max'),
