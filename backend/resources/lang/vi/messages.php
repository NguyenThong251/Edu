...
return [
    ...
    'status_required' => 'Trạng thái là trường bắt buộc.',
    'invalid_status' => 'Trạng thái không hợp lệ. Chỉ chấp nhận giá trị active hoặc inactive.',
    'course_status_update_success' => 'Cập nhật trạng thái khóa học thành công.',
    'validation_error' => 'Có lỗi xảy ra trong quá trình xác thực.',
    'title_required' => 'Tiêu đề là trường bắt buộc.',
    'thumbnail_required' => 'Ảnh đại diện là trường bắt buộc.',
    'thumbnail_image' => 'Ảnh đại diện phải là tệp hình ảnh.',
    'thumbnail_mimes' => 'Ảnh đại diện chỉ chấp nhận các định dạng: jpeg, png, jpg, gif, svg.',
    'thumbnail_max' => 'Kích thước ảnh đại diện không được vượt quá 2MB.',
    'price_required' => 'Giá là trường bắt buộc.',
    'price_numeric' => 'Giá phải là một số hợp lệ.',
    'type_sale_required' => 'Loại khuyến mãi là trường bắt buộc.',
    'type_sale_invalid' => 'Loại khuyến mãi chỉ được phép là percent hoặc price.',
    'course_create_success' => 'Tạo khóa học thành công.',
    'course_update_success' => 'Cập nhật khóa học thành công.',
    'course_not_found' => 'Không tìm thấy khóa học.',
    ...
    //Section
    'section_fetch_success' => 'Lấy danh sách chương thành công.',
    'section_create_success' => 'Tạo chương thành công.',
    'section_update_success' => 'Cập nhật chương thành công.',
    'sections_order_update_success' => 'Cập nhật thứ tự chương thành công.',
    'section_soft_delete_success' => 'Xóa chương thành công.',
    'section_restore_success' => 'Khôi phục chương thành công.',
    'section_force_delete_success' => 'Xóa vĩnh viễn chương thành công.',
    'section_not_found' => 'Không tìm thấy chương.',
    'course_id_required' => 'Khóa học là bắt buộc.',
    'course_id_invalid' => 'Khóa học không tồn tại.',
    'title_required' => 'Tiêu đề là bắt buộc.',
    'status_required' => 'Trạng thái là bắt buộc.',
    'status_invalid' => 'Trạng thái không hợp lệ.',
    'sections_fetch_success' => 'Lấy danh sách chương thành công.',
    'section_detail_success' => 'Chi tiết chương được lấy thành công.',
    ...
    'lecture_restore_success' => 'Khôi phục bài giảng thành công.',
    'lecture_force_delete_success' => 'Xóa vĩnh viễn bài giảng thành công.',
    'lecture_not_found' => 'Không tìm thấy bài giảng.',
    'lecture_section_updated' => 'Cập nhật chương của bài giảng thành công.',
    'lecture_status_updated' => 'Cập nhật trạng thái bài giảng thành công.',
    'content_upload_failed' => 'Tải lên nội dung thất bại.',
    'invalid_data_format' => 'Dữ liệu không đúng định dạng.',
    'content_fetch_success' => 'Lấy danh sách nội dung thành công.',
    ...
    //Question
    'quiz_id_required' => 'Quiz ID là bắt buộc.',
    'quiz_id_invalid' => 'Quiz ID không hợp lệ.',
    'question_required' => 'Câu hỏi là bắt buộc.',
    'options_required' => 'Tùy chọn là bắt buộc.',
    'options_invalid_format' => 'Tùy chọn phải là một JSON hợp lệ.',
    ...
    'question_soft_delete_success' => 'Xóa mềm câu hỏi thành công.',
    ...
    'question_detail_success' => 'Lấy thông tin chi tiết câu hỏi thành công.',
    'validation_error' => 'Lỗi xác thực.',
    'question_not_found' => 'Không tìm thấy câu hỏi.',
    'quiz_not_found' => 'Không tìm thấy bài giảng.',
    'invalid_status' => 'Trạng thái không hợp lệ. Giá trị hợp lệ là active hoặc inactive.',
    'question_update_success' => 'Cập nhật câu hỏi thành công.',
    'questions_fetch_success' => 'Danh sách câu hỏi được lấy thành công.',
    'questions_order_update_success' => 'Thứ tự câu hỏi được cập nhật thành công.',
    'invalid_data_format' => 'Dữ liệu không hợp lệ.',
